...
```sql
`r paste(readLines(devtools::package_file(
    "./data-raw/aafsql/T2208 AAF ADM 11 TagAFInspect 20180303.sql"
)), collapse = '\n')`
```
...
```sql
`r paste(readLines(devtools::package_file(
    "./data-raw/aafsql/T2208 AAF ADM 12 TagAF 20180305.sql"
)), collapse = '\n')`
```
...
```sql
`r paste(readLines(devtools::package_file(
    "./data-raw/aafsql/T2208 AAF ADM 20 ConstructMethods 20180301.sql"
)), collapse = '\n')`
```
...
```sql
`r paste(readLines(devtools::package_file(
    "./data-raw/aafsql/T2208 AAF ADM ApplyMethods Generic 20180621.sql"
)), collapse = '\n')`
```
...
```sql
`r paste(readLines(devtools::package_file(
    "./data-raw/aafsql/T2208 AAF ADM 30 ApplyMethods 20180301.sql"
)), collapse = '\n')`
```
...
```sql
`r paste(readLines(devtools::package_file(
    "./data-raw/aafsql/T2208 AAF ADM 31 ApplyMethods LSOA 20180305.sql"
)), collapse = '\n')`
```
...
```sql
`r paste(readLines(devtools::package_file(
    "./data-raw/aafsql/T2208 AAF ADM 31 ApplyMethods LSOA Condition 20180305.sql"
)), collapse = '\n')`
```
...
```sql
`r paste(readLines(devtools::package_file(
    "./data-raw/aafsql/T2208 AAF ADM ApplyMethods Generic Readm 20180417.sql"
)), collapse = '\n')`
```
